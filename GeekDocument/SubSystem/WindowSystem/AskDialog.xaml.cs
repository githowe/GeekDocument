...
namespace GeekDocument.SubSystem.WindowSystem
{
    ...
    public partial class AskDialog : XDialog
    {
        ...
        /// <summary>按钮组</summary>
        public ButtonGroup Group { get; set; } = ButtonGroup.YesNoCancel;
        ...
        public Action<AskDialog, object?>? HandleResult { get; set; } = null;

        public object? OperateObject { get; set; } = null;
        ...
        private void AskDialog_Closed(object? sender, EventArgs e) => HandleResult?.Invoke(this, OperateObject);
