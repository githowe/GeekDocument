    ...
    public class XMainWindow : XWindow
    {
        ...
        public double WindowBorderWdith
        {
            get
            {
                ...
                // 缩放窗口的边框宽度
                int resizeBorderWidth = User32Interop.GetSystemMetrics(SystemMetric.SM_CXFRAME);
                // 窗口填充宽度
                int addedBorderWidth = User32Interop.GetSystemMetrics(SystemMetric.SM_CXPADDEDBORDER);
